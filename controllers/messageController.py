...
help_message = (
    ...
    "Погладить (ответ) — погладить пользователя.\n"
    "Админ помощь - команды для администрации.\n"
    ...
    "Лото карточка - посмотреть свою карточку с анализом линий.\n"
    "Лото числа - посмотреть все вытянутые числа.\n"
    "Лото результаты - показать текущие результаты всех игроков.\n"
    "Лото подделать - попытаться подделать случайное число (шанс поймать 30%).\n"
    "Лото читеры - посмотреть список исключенных игроков.\n"
    "Лото стоп - завершить игру (только ведущий).\n\n"
    "🎯 ПРАВИЛА: Победа по заполнению любой горизонтальной линии!\n"
    "2-е и 3-е места определяются по количеству зачеркнутых чисел.\n"
    "😈 Подделка результатов может караться исключением из игры!\n\n"
)
