...
help_message = (
    ...
    "Погладить (ответ) — нежно погладить пользователя.\n"
    ...
    "😈 ЧИТЕРСТВО: Рискуйте на свой страх и риск!\n\n"

    "🎟️ ЛОТЕРЕЯ\n"
    "Лотерея - создать новую лотерею (создатель и админы).\n"
    "Лотерея билет @пользователь количество - выдать билеты пользователю.\n"
    "Лотерея мои - посмотреть свои билеты.\n"
    "Лотерея список - список всех участников лотереи.\n"
    "Лотерея розыгрыш - провести розыгрыш призов.\n"
    "Лотерея стоп - остановить текущую лотерею.\n"
    "Лотерея победители [число] - установить количество мест (1-10).\n\n"
    "🎯 ПРАВИЛА ЛОТЕРЕИ: Каждый билет имеет уникальный 6-значный номер.\n"
    "По умолчанию: 3 призовых места. Можно изменить от 1 до 10.\n"
    "💰 Каждый билет добавляет 100 монет в призовой фонд!\n\n"

    "👑 АДМИНИСТРИРОВАНИЕ\n"
    "Стать создателем - стать создателем беседы (только если его нет).\n"
    "Админка - посмотреть список администраторов и модераторов.\n"
    "Мои права - узнать свой уровень доступа.\n"
    "Права (ответ) - узнать уровень доступа пользователя.\n"
    "Повысить (ответ) - повысить пользователя в должности.\n"
    "Понизить (ответ) - понизить пользователя в должности.\n"
    "Передать (ответ) - передать права создателя пользователю (только создатель).\n"
    "Кик (ответ) - исключить пользователя из беседы (модераторы и выше).\n"
    "Стоп игры - принудительно завершить все игры (модераторы и выше).\n"
    "Админ помощь - подробная справка по администрированию.\n"
)
